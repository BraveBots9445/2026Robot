    ...
    def publishPositions() -> list[StructPublisher]:
        ...
        for attr in dir( RebuiltPositions ):
            if not attr.startswith("__"):
                ...
                topic.set( Rebuilt.getPosition( RebuiltPositions.__getattribute__( RebuiltPositions, attr ) ) )
                publishers.append( topic )
        return publishers

class RebuiltPositions:
    Hub: Final[RebuiltPositions] = Pose3d( Translation3d( inchesToMeters( 158.6 + 47.0 / 2 ), inchesToMeters( 317.7 / 2 ), inchesToMeters( 72.0 ) ), Rotation3d() )
    PassLeft: Final[RebuiltPositions] = Pose3d( Translation3d( inchesToMeters( 18 ), inchesToMeters( 18 ), 0.0 ), Rotation3d() )
    PassRight: Final[RebuiltPositions] = Pose3d( Translation3d( inchesToMeters( 18 ), Rebuilt.Width - inchesToMeters( 18 ), 0.0 ), Rotation3d() )
