...
from tools.BraveLogger import BraveLogger, IndexerData
...
class Indexer(Subsystem):
    ...
    _motor: TalonFX
    """
    The motor that spins the indexer.
    This is a krakenx60
    """
    ...
    def __init__(
        ...
        self._data = IndexerData(0.0, 0.0, 0.0, 0.0)
        ...
        SmartDashboard.putData("Indexer", self)
